        ...
        <div className={styles.footerTop}>
          <div className={styles.footerColumn}>
            ...
            <p className={styles.description}>
              We transform brands through creative excellence and strategic innovation.
            </p>
          ...
          <div className={styles.footerColumn}>
            ...
            <ul className={styles.footerLinks}>
              ...
              <li><a href="#" className={styles.footerLink}>Creative Services</a></li>
              <li><a href="#" className={styles.footerLink}>Technology</a></li>
              <li><a href="#" className={styles.footerLink}>Content Strategy</a></li>
          ...
          <div className={styles.footerColumn}>
            ...
            <ul className={styles.footerLinks}>
              ...
              <li><a href="#" className={styles.footerLink}>Whitepapers</a></li>
